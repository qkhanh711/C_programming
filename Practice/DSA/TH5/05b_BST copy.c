...
int Predecessor(BTNode *cur, int value) {
    BTNode *max = BSTT(cur, value)->left;
...
int Successor(BTNode *cur, int value) {
    BTNode *min = BSTT(cur, value)->right;
...
int main(void)
{
    ...
    printf("%d %d\n", Predecessor(nodes[0], value), Successor(nodes[0], value));
